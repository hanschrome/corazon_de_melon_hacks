...
var signatureFlower = generateSignature(publicKey, privateKey, "GET", urlFlower, null, timestampFlower);
...
var signatureCash = generateSignature(publicKey, privateKey, "GET", urlCash, null, timestampCash);
